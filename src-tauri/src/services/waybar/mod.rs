...
impl Default for WaybarConfigSnapshot {
    fn default() -> Self {
        Self {
            ...
            passthrough: Value::Object(Map::new()),
            raw_json: String::new(),
        }
    }
}
...
impl WaybarConfigService {
    ...
    pub fn save_snapshot(
        ...
        globals_map.insert(
            "height".to_string(),
            Value::Number(number_from_f64(payload.globals.height, 32.0)),
        );
        globals_map.insert(
            "margin".to_string(),
        ...
        globals_map.insert(
            ...
            Value::Number(number_from_f64(payload.globals.border_radius, 8.0)),
        );
        globals_map.insert(
...
fn default_root_value() -> Value {
    ...
    for (key, value) in default_modules_map() {
    ...
    omarchist.insert(
        ...
        json!({
            ...
            "border_radius": globals.border_radius,
            "background": globals.background,
            "foreground": globals.foreground
        }),
    );
    map.insert("_omarchist".to_string(), Value::Object(omarchist));
...
mod tests {
    ...
    fn default_config_contains_known_modules() {
        ...
        assert_eq!(snapshot.layout.center.len(), 1);
        assert!(snapshot.modules.contains_key("clock"));
    }
}
