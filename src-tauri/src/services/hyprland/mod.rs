...
use crate::types::{
    blur_field_registry, decoration_field_registry, general_field_registry, shadow_field_registry,
    snap_field_registry, BlurField, DecorationField, GeneralField, HyprlandConfigError,
    ...
    HyprlandValue, ShadowField, SnapField,
};
...
impl HyprlandConfigService {
    ...
    pub fn persist_general_overrides(
        ...
        self.write_override_file(&override_maps, &decoration_maps, &parsed.preserved_lines)
    }
    ...
    pub fn persist_decoration_overrides(
        ...
        self.write_override_file(&general_maps, &override_maps, &parsed.preserved_lines)
    }
    ...
    fn parse_override_file(&self) -> HyprlandResult<ParsedOverrides> {
        ...
        for line in reader.lines() {
            ...
            if !in_general_section && !in_decoration_section {
                preserved_lines.push(line);
                continue;
            }
