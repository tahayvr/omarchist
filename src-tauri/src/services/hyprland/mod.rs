...
use crate::types::{
    ...
    AnimationField, BlurField, DecorationField, GeneralField, HyprlandAnimationSettings,
    HyprlandAnimationSnapshot, HyprlandConfigError, HyprlandDecorationOverrideMaps,
    HyprlandDecorationSettings, HyprlandDecorationSnapshot, HyprlandGeneralOverrideMaps,
    HyprlandGeneralSettings, HyprlandGeneralSnapshot, HyprlandInputOverrideMap,
    HyprlandInputSettings, HyprlandInputSnapshot, HyprlandResult, HyprlandValue, InputField,
    ShadowField, SnapField,
};
...
impl HyprlandConfigService {
    ...
    pub fn load_input_snapshot(&self) -> HyprlandResult<HyprlandInputSnapshot> {
        ...
        overrides.apply_overrides(&parsed.input)?;

        let mut effective = HyprlandInputSettings::with_defaults();
        effective.apply_overrides(&parsed.input)?;
    ...
    pub fn persist_input_overrides(&self, overrides: &HyprlandInputSettings) -> HyprlandResult<()> {
        ...
        let override_map = HyprlandInputOverrideMap {
            settings: overrides.to_override_map(),
        };
    ...
    fn parse_override_file(&self) -> HyprlandResult<ParsedOverrides> {
        ...
        for line in reader.lines() {
            ...
            if in_input_section {
                if is_section_start(trimmed, "touchpad") {
