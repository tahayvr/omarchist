...
<Card.Root>
	<Card.Header>
		...
		<Card.Description class="text-xs tracking-wide uppercase">
			Changes auto-save to <span class="font-semibold">~/.config/waybar/config.jsonc</span>.
		</Card.Description>
	</Card.Header>
	<Card.Content
	...
	>
		...
		<div class="flex items-center gap-2">
			...
			<Button variant="outline" onclick={() => restartApp('waybar')}>Restart Status Bar</Button>
		</div>
	</Card.Content>
</Card.Root>
