Welcome to Omarchist! A GUI application for [Omarchy](https://omarchy.org/) Linux.
...
- **Flows**: String actions together, like Shortcuts on a Mac, and run them from a keybind, the app launcher, at startup, or with `omarchist flow run`. Start from a template and share flows as files.
...
Omarchist is available on Omarchy Linux via the AUR.
